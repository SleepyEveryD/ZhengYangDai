...
import { SearchIcon, NavigationIcon, CircleDotIcon, UserIcon, LogInIcon } from 'lucide-react';
...
export default function MapExplorer({ user, navigateTo }: MapExplorerProps) {
